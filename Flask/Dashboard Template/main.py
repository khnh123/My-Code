...
class Form1(FlaskForm):
    ...
    value3 = SelectField('Colormaps', choices=data.cmaps['Sequential'], default=data.cmaps['Sequential'])
...
def update_values():
    ...
    if request.method == 'POST':
        ...
        data.return_cmap(cmap_name=value3)
        if error:
...
def new_values_update(values, error):
    ...
    if new_values and error == None:
        ...
        if request.path == '/':
            ...
            print('Update: Page 4-', request.path)
